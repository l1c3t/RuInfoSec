...
В следующей статье я покажу вам, как использовать Jupyter Notebook для документирования и обмена сценариями по обнаружению угроз в вашей организации и с сообществом.
## Ссылки
